...
export default function IletisimPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800">
      {/* Hero (daha kompakt) */}
      <section className="bg-gradient-to-r from-slate-800 to-slate-700 text-white border-b border-slate-600">
        <div className="mx-auto w-full max-w-screen-xl px-4 py-12 text-center">
          {/* Buradaki başlığı/alt yazıyı istediğin gibi değiştir */}
          <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight mb-2">İletişim</h1>
          <p className="text-base md:text-lg text-slate-200">
            Soruların için bize yaz—en kısa sürede dönüş yapalım.
          </p>
        </div>
      </section>

      {/* Dış sarmal: tam genişlik + 12 kolon grid */}
      <div className="w-full py-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          {/* Sol Sponsor (kenara yakın durması için sadece iç padding) */}
